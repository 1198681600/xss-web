...
const AllProjectsList = ({ onSelectProject, selectedProjectId, refreshTrigger }) => {
  ...
  const loadProjects = async () => {
    ...
    setError('');
    try {
      const projectList = await projectService.getOtherProjects();
    ...
    <div className="project-list">
      <div className="project-list__header">
        <div className="project-list__header-left">
          <h2 className="project-list__title">🗂️ 所有用户项目</h2>
              ...
              <div className="project-list__card-content">
                ...
                <div className="project-list__info-grid">
                  <div className="project-list__info-item">
                    <span className="project-list__info-label">创建者:</span>
